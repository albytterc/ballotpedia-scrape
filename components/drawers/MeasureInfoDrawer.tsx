        ...
        <Drawer.Navigator initialRouteName="Measures" drawerContent={props => {
            return (
                <DrawerContentScrollView {...props}>
                    ...
                    <DrawerItem label="Measures" onPress={() => props.navigation.navigate("Measures", params)} />
                </DrawerContentScrollView>
            )
          }} >
            <Drawer.Screen name="Measure Info" initialParams={params} component={MeasureTabsNavigator}/>
          </Drawer.Navigator>
    )
}
